...
export default function PulmonaryDashboard({ navigation }) {
  const exercises = [
    { label: "Diaphragmatic Breathing", key: "DIAPHRAGMATIC_BREATHING" },
    { label: "Thoracic Expansion with Arm Lift", key: "THORACIC_EXPANSION_ARM_LIFT" },
    { label: "Static Standing Endurance", key: "STATIC_STANDING" },
    { label: "Marching in Place", key: "MARCHING_IN_PLACE" },
  ];
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.headerContainer}>
            <Text style={styles.title}>Pulmonary Rehab</Text>
            <View style={styles.underline} />
            <Text style={styles.subtitle}>Improving lung capacity and endurance</Text>
          </View>
          ...
          <View style={styles.tipCard}>
            <View style={styles.tipHeader}><Text style={styles.tipTitle}>💡 Breathing Tip</Text></View>
            <Text style={styles.tipText}>Inhale deeply through your nose and exhale slowly through pursed lips for maximum benefit.</Text>
          </View>
        </ScrollView>
      </View>
    </ImageBackground>
