...
export default function StrokeDashboard({ navigation }) {
  const exercises = [
    { label: "Seated Shoulder Flexion", key: "SEATED_SHOULDER_FLEXION" },
    { label: "Seated Elbow Extension-Flexion", key: "SEATED_ELBOW_FLEXION_EXTENSION" },
    { label: "Weight Shift", key: "WEIGHT_SHIFT" },
  ];
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.headerContainer}>
            <Text style={styles.title}>Stroke Recovery</Text>
            <View style={styles.underline} />
            <Text style={styles.subtitle}>Restoring neuro-motor coordination</Text>
          </View>
          ...
          <View style={styles.tipCard}>
            ...
            <Text style={styles.tipText}>Quality over speed. The AI is looking for precise, symmetrical movements to help rewire neural pathways.</Text>
          </View>
        </ScrollView>
      </View>
    </ImageBackground>
