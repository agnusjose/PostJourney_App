...
export default function OrthopedicDashboard({ navigation }) {
  const exercises = [
    { label: "Quadriceps Set", key: "QUADRICEPS_SET" },
    { label: "Straight Leg Raise", key: "STRAIGHT_LEG_RAISE" },
    { label: "Standing Hip Abduction", key: "STANDING_HIP_ABDUCTION" },
    { label: "Hip Extension (Standing)", key: "HIP_EXTENSION" },
    { label: "Pendulum Exercise", key: "PENDULUM_EXERCISE" },
  ];
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.headerContainer}>
            <Text style={styles.title}>Orthopedic Rehab</Text>
            <View style={styles.underline} />
            <Text style={styles.subtitle}>Targeted joint and muscle strengthening</Text>
          </View>
          ...
          <View style={styles.tipCard}>
            <View style={styles.tipHeader}><Text style={styles.tipTitle}>💡 Pro Tip</Text></View>
            <Text style={styles.tipText}>Proper alignment is key. Keep your core engaged to protect your spine during these movements.</Text>
          </View>
        </ScrollView>
      </View>
    </ImageBackground>
