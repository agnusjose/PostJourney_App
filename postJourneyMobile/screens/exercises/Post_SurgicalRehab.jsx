...
export default function PostSurgicalDashboard({ navigation }) {
  const exercises = [
    { label: "Sit-to-Stand", key: "SIT_TO_STAND" },
    { label: "Seated Knee Extension", key: "SEATED_KNEE_EXTENSION" },
    { label: "Heel Slides", key: "HEEL_SLIDES" },
    { label: "Bed Mobility – Roll", key: "BED_MOBILITY_ROLL" },
  ];
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.headerContainer}>
            <Text style={styles.title}>Post-Surgical Rehab</Text>
            <View style={styles.underline} />
            <Text style={styles.subtitle}>Safely restoring your mobility</Text>
          </View>
          ...
          <View style={styles.tipCard}>
            <View style={styles.tipHeader}><Text style={styles.tipTitle}>💡 Care Note</Text></View>
            <Text style={styles.tipText}>The AI tracks your range of motion. Try to reach the target angles shown on your screen during the session.</Text>
          </View>
        </ScrollView>
      </View>
    </ImageBackground>
