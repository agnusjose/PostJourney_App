...
export default function ElderlyCareDashboard({ navigation }) {
  const exercises = [
    { label: "Tandem Standing", value: "tandem-standing", key: "TANDEM_STANDING" },
    { label: "Turn-in-Place", value: "turn-in-place", key: "TURN_IN_PLACE" },
  ];
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.subtitle}>Select a stability exercise to begin</Text>
          </View>
          ...
          <View style={styles.tipCard}>
            ...
            <Text style={styles.tipText}>Perform these exercises near a sturdy chair or wall for extra support if needed.</Text>
          </View>
        </ScrollView>
      </View>
    </ImageBackground>
